...
- [x] Add member personalization settings, including a light/dark style choice; light remains the current default, and dark should use a mainly black background with white lettering.
